...
class Admin:
    ...
    # def loan_taken_feature(self,value):
    #     if value == 'on':
    #         self.loan_feature = True
    #     elif value =='off':
    #         self.loan_feature = False
    #     else:
    #         print('please input courrtct input!!')
...
while True:
    if current_user is None:
        ...
        if ch == 1:
                ...
                if current_user.name == 'admin':
                    ...
                    while True:
                        ...
                        if op == 1:
                            ...
                            python.loan_taken_feature(value)
                        elif op == 7:
                            current_user = None
                            break
                        else:
            ...
            # print('\n\n----------------------king is back ----------------------')
            # print('your list is',python.users)
            # python.show_all_user()
