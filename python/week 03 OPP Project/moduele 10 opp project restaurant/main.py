...
def main():
    ...
    restaurant.receive_payment(order_1, 3000, customer_1)
    print('revenue and bailance after first customer',restaurant.revenue,restaurant.balance)
    ...
    # pay rent
    restaurant.pay_expense(restaurant.rent,'rant')
